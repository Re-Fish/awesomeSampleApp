...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button1.setOnClickListener {
            ...
            textView.text = "Button1 has been pressed"
        }
        button2.setOnClickListener {
            Log.e("@#$", "Button2 has been pressed")
            textView.text = "Button2 has been pressed"
        }
        button3.setOnClickListener {
            Log.e("@#$", "Button3 has been pressed")
            textView.text = "Button3 has been pressed"
        }
        button4.setOnClickListener {
            Log.e("@#$", "Button4 has been pressed")
            textView.text = "Button4 has been pressed"
        }
    }
}
